    ...
    <>
      ...
      <div className={`sidebar-box-open ${isOpen ? "open" : "close"}`}>
        ...
        <p
          ...
          onClick={() => handleNavigate("/home-client")}
        >
          Restaurantes
        </p>
        <p
          className="sidebar-buttons"
          onClick={() => handleNavigate("/track-order-client")}
        >
          Acompanhar pedido
        </p>
        ...
        <p
          className="sidebar-buttons"
          onClick={() => handleNavigate("/wallet-client")}
        >
          Carteira
        </p>
        ...
        <p
          className="sidebar-buttons"
          onClick={() => handleNavigate("/order-record-client")}
        >
        ...
        <p
          className="sidebar-buttons"
          onClick={() => handleNavigate("/suport-client")}
        >
          Suporte
        </p>
