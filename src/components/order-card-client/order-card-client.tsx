...
const OrderCardClient: React.FC = () => {
    ...
    const [status] = useState<'em_preparo' | 'saiu_pra_entrega' | 'entregue'>
    ('entregue'); /*Estado do pedido */
...
<div className='order-card-client'>
    ...
    <div className='order-card-client-itensbox'>
        ...
        <div className='order-card-client-itensbox-columns'>
            ...
            <div className='order-card-client-itensbox-column2'>
                <p className='order-card-client-itensbox-title'>Quantdade</p>
    ...
    <Button label="Cancelar pedido" variant="primary" disabled={status !== 'em_preparo'} />
